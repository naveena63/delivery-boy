...
//import com.iprismtech.wewriteforyou.activities.HomeActivityContract;
...
public class MyExceptionHandler implements Thread.UncaughtExceptionHandler {
    ...
    public void uncaughtException(Thread thread, final Throwable exception) {
        ...
        intent = PendingIntent.getActivity(myContext, 0, new Intent(myContext, FirstMainActivity.class), PendingIntent.FLAG_ONE_SHOT);
