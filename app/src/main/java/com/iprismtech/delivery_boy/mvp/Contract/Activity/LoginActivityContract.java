...
public interface LoginActivityContract {
    ...
    interface IPresenter {
        ...
        void agent_login(Context context, APIResponseCallback apiResponseCallback, Map<String, String> requestBody);
        void update_device_token(Context context, APIResponseCallback apiResponseCallback, Map<String, String> requestBody);
