...
public interface AdminSupportActivityContract {
    ...
    interface IPresenter {
        ...
        void customer_support(Context context, APIResponseCallback apiResponseCallback, Map<String, String> requestBody);
