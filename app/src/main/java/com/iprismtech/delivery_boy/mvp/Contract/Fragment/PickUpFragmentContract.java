...
public interface PickUpFragmentContract {
    ...
    interface IPresenter {
        ...
        void agent_pickup_orders(Context context, APIResponseCallback apiResponseCallback, Map<String, String> requestBody);
        void start_warehouse_service(Context context, APIResponseCallback apiResponseCallback, Map<String, String> requestBody);
