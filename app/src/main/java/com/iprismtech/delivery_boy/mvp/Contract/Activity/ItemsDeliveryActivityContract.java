...
public interface ItemsDeliveryActivityContract {
    ...
    interface IPresenter {
        ...
        void warehouse_items_dropped(Context context, APIResponseCallback apiResponseCallback, Map<String, String> requestBody);
