...
public interface AccountSettingActivityContract {
    ...
    interface IPresenter {
        ...
        void agent_profile(Context context, APIResponseCallback apiResponseCallback, Map<String, String> requestBody);
        void agent_update_profile(Context context, APIResponseCallback apiResponseCallback, Map<String, String> requestBody);
