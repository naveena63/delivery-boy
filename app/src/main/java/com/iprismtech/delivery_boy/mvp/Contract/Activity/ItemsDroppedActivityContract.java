...
public interface ItemsDroppedActivityContract {
    ...
    interface IPresenter {
        ...
        void items_delivered(Context context, APIResponseCallback apiResponseCallback, Map<String, String> requestBody);
