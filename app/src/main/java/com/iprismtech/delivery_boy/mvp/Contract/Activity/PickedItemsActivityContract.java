...
public interface PickedItemsActivityContract {
    ...
    interface IPresenter {
        ...
        void agent_get_home_delivery_details(Context context, APIResponseCallback apiResponseCallback, Map<String, String> requestBody);
        void check_single_home_delivery_items(Context context, APIResponseCallback apiResponseCallback, Map<String, String> requestBody);
        void divery_elitems_picked(Context context, APIResponseCallback apiResponseCallback, Map<String, String> requestBody);
