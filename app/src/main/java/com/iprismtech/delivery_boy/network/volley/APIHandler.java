package com.iprismtech.delivery_boy.network.volley;
...
import com.iprismtech.delivery_boy.network.listener.IDialogCallback;
import com.iprismtech.delivery_boy.network.responcedos.CommonResponse;
import com.iprismtech.delivery_boy.network.utils.Utils;
...
public class APIHandler implements IDialogCallback {
    ...
    private void sendRequest2() {
        JsonObjectRequest jsonRequest = null;
        try {
            jsonRequest = new JsonObjectRequest(methodType, url,
                    new Response.Listener<JSONObject>() {
                        @Override
                        public void onResponse(JSONObject response) {
                            try {
